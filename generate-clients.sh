...
openapi-generator-cli generate -i sleeper-openapi.yaml -g typescript-nestjs -o $TYPSCRIPT_NESTJS_DIR -p withInterfaces=true -p npmName=$TYPSCRIPT_NESTJS_NPMNAME -p npmVersion=$NPM_VERSION
openapi-generator-cli generate -i sleeper-openapi.yaml -g typescript-angular -o $TYPSCRIPT_ANGULAR_DIR -p withInterfaces=true -p npmName=$TYPSCRIPT_ANGULAR_NPMNAME -p npmVersion=$NPM_VERSION
