...
import { TrendingPlayer } from '../model/models';
...
export class PlayersService implements PlayersServiceInterface {
     ...
     */
    public playersNflGet(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<{ [key: string]: Player; }>;
    public playersNflGet(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<{ [key: string]: Player; }>>;
    public playersNflGet(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<{ [key: string]: Player; }>>;
    public playersNflGet(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<{ [key: string]: Player; }>(`${this.configuration.basePath}/players/nfl`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public playersSportTrendingTypeGet(sport: 'nfl' | 'nba' | 'lcs', type: 'add' | 'drop', lookbackHours?: string, limit?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<TrendingPlayer>>;
    public playersSportTrendingTypeGet(sport: 'nfl' | 'nba' | 'lcs', type: 'add' | 'drop', lookbackHours?: string, limit?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<TrendingPlayer>>>;
    public playersSportTrendingTypeGet(sport: 'nfl' | 'nba' | 'lcs', type: 'add' | 'drop', lookbackHours?: string, limit?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<TrendingPlayer>>>;
    public playersSportTrendingTypeGet(sport: 'nfl' | 'nba' | 'lcs', type: 'add' | 'drop', lookbackHours?: string, limit?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        if (lookbackHours !== undefined && lookbackHours !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>lookbackHours, 'lookback_hours');
        }
        ...
        return this.httpClient.get<Array<TrendingPlayer>>(`${this.configuration.basePath}/players/${encodeURIComponent(String(sport))}/trending/${encodeURIComponent(String(type))}`,
            {
