...
export interface PlayersServiceInterface {
     ...
     */
    playersNflGet(extraHttpRequestParams?: any): Observable<{ [key: string]: Player; }>;
     ...
     */
    playersSportTrendingTypeGet(sport: 'nfl' | 'nba' | 'lcs', type: 'add' | 'drop', lookbackHours?: string, limit?: string, extraHttpRequestParams?: any): Observable<Array<TrendingPlayer>>;
